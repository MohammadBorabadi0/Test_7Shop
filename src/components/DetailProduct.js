...
const DetailProduct = () => {
    ...
    if (product)
        return (
            <section className='flex flex-col sm:flex-row bg-gray-300 md:max-w-7xl md:mx-auto'>
                ...
                <div className='flex flex-col sm:flex-1 gap-6 bg-white rounded-t-[2.5rem] sm:rounded-none px-6 py-8'>
                    ...
                    <div className='flex flex-col gap-3'>
                        ...
                        <div className='flex gap-2'>
                            {size.map((item, index) => (
                                <button
                                    key={index}
                                    className={`px-2 py-1 bg-gray-100 shadow-lg rounded-md font-semibold text-lg ${active === index && 'bg-slate-800 text-white'}`}
                    ...
                    <div className='flex items-center justify-center bg-slate-900 text-white gap-2 text-lg font-bold cursor-pointer py-1.5 rounded-xl sm:w-fit sm:px-6'>
                        <BiCart size='22px' />
