        ...
        <Layout>
            ...
            <section className='flex flex-col lg:flex-row gap-10'>
                <div className='flex-1'>
                    <img src='./images/aboutus.jpg' alt='shoe' className='w-full h-full rounded-lg' />
                </div>
                <div className='flex-1'>
                    <span className='inline-block mb-4 pb-1 text-2xl font-semibold border-b-4 border-orange-500 text-slate-800'>Our Story</span>
                    <p>
